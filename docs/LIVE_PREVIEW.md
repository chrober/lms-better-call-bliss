...
No playlist was written. Because the Wohnzimmer player was actively playing, the LMS service was deliberately not restarted. The 0.11.0 source and binary are deployed on disk; Perl modules and the compiled Template Toolkit view will activate at the next safe LMS restart.
