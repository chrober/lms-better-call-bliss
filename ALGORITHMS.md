...
Only **Adaptive dynamic weighting** is currently connected to Better Call Bliss. Static Weights and Extended Isolation Forest remain BlissMixer capabilities; their future Better Call Bliss entries are disabled.
...
## Options shared across workflows
...
| Last.fm artist probability | 1–100%; default 25 | Seed-growth endorsed-artist target. Bridge modes do not use the numeric value. |
