#!/usr/bin/env python3
"""Update the LMS plugin repository feed for Better Call Bliss."""
...
PLUGIN_NAME = "BetterCallBliss"
PLUGIN_TITLE = "Better Call Bliss"
PLUGIN_DESC = (
    "Playlist Breaking Bad? Better Call Bliss. Optimize saved playlists using "
    "Bliss analysis, repeat constraints, and optional Last.fm evidence."
)
